...
public class NumberOfWaysToArriveAtDestinationProblemTests
{
    ...
    public void Test(int initialString, int[][] numOfRows, int expectedResult)
    {
        var problem = new NumberOfWaysToArriveAtDestinationProblem();

        var result = problem.CountPaths(initialString, numOfRows);
